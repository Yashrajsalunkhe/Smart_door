...
export default function FaceRecognition() {
  ...
  // Set up webcam and load models on component mount
  useEffect(() => {
    let isMounted = true;
    async function init() {
      await loadModels();
  ...
  }, [isDetecting, stream, confidenceThreshold, alertOnUnknown, saveUnknown, saveKnown, isModelLoaded]);
  ...
  return (
    <div className="p-4 md:p-8 fade-in">
      {/* Show loading indicator if models are not loaded */}
      {!isModelLoaded ? (
        <div className="flex flex-col items-center justify-center h-96">
          <span className="text-lg text-gray-600 dark:text-gray-300 mb-4">Loading face recognition models...</span>
